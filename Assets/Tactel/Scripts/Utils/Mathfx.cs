...
namespace Tactel.Math
{
    /// <summary>
    /// Got there: http://wiki.unity3d.com/index.php?title=Mathfx
    /// </summary>
    public sealed class Mathfx
    {
        ...
        {
            return new Vector2(((1.0f - value) * start.x) + (value * end.x), ((1.0f - value) * start.y) + (value * end.y));
        }

        public static Vector3 Lerp(Vector3 start, Vector3 end, float value)
        {
            return new Vector3(((1.0f - value) * start.x) + (value * end.x), ((1.0f - value) * start.y) + (value * end.y), ((1.0f - value) * start.z) + (value * end.z));
        }
